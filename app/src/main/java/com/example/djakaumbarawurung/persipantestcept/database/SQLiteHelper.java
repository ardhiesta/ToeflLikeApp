...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    // TABLE PERTANYAAN READING
   ;

    //TABLE_AKTIVITAS USER

//    public static final String TABLE_AktivitasUser = "TB_user";
//    public static final String COLUMN_PILIHAN_USER = "Pilihan_User";
...
//    private static final String DATABASE_AKTIVITAS_CREATE = "create table " + TABLE_AktivitasUser + " (" +
//            COLUMN_PILIHAN_USER + " TEXT NOT NULL, " + COLUMN_ID + " INTEGER );";
